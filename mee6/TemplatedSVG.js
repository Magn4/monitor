...
! function(e, t) {
    ...
    function n(e, t) {
        ...
        try {
            o && (this.lineNumber = i, this.endLineNumber = s, Object.defineProperty ? (Object.defineProperty(this, "column", {
                value: a,
                enumerable: !0
...
! function(t, r) {
    ...
    r.default = function(t) {
        t.registerHelper("each", (function(t, r) {
            if (!r) throw new i.default("Must pass iterator to #each");
            var n, s = r.fn,
                a = r.inverse,
                l = 0,
                u = "",
            ...
            function h(e, r, n) {
                c && (c.key = e, c.index = r, c.first = 0 === r, c.last = !!n, p && (c.contextPath = p + e)), u += s(t[e], {
                    data: c,
                    blockParams: o.blockParams([t[e], e], [p + e, null])
                })
            }
            if (r.data && r.ids && (p = o.appendContextPath(r.data.contextPath, r.ids[0]) + "."), o.isFunction(t) && (t = t.call(this)), r.data && (c = o.createFrame(r.data)), t && "object" == typeof t)
                if (o.isArray(t))
                    for (var f = t.length; l < f; l++) l in t && h(l, l, l === t.length - 1);
                else if (e.Symbol && t[e.Symbol.iterator]) {
                for (var d = [], g = t[e.Symbol.iterator](), m = g.next(); !m.done; m = g.next()) d.push(m.value);
                for (f = (t = d).length; l < f; l++) h(l, l, l === t.length - 1)
            } else n = void 0, Object.keys(t).forEach((function(e) {
...
! function(e, t) {
    ...
    t.default = function(e) {
        e.registerHelper("with", (function(e, t) {
            ...
            var i = t.data;
            return t.data && t.ids && ((i = n.createFrame(t.data)).contextPath = n.appendContextPath(t.data.contextPath, t.ids[0])), r(e, {
                data: i,
                blockParams: n.blockParams([e], [i && i.contextPath])
            })
        }))
    }, e.exports = t.default
}(I, I.exports);
    ...
    var r = s,
        n = {
            ...
            lookupLevel: function(e) {
                if ("string" == typeof e) {
                    var t = r.indexOf(n.methodMap, e.toLowerCase());
...
de.__esModule = !0, de.wrapHelper = function(e, t) {
    ...
    var n = {
        ...
        invokePartial: function(r, n, o) {
            ...
            if (null == s && t.compile && (o.partials[o.name] = t.compile(r, e.compilerOptions, t), s = o.partials[o.name](n, i)), null != s) {
                if (o.indent) {
    ...
    var r = function() {
        var e = {
                ...
                performAction: function(e, t, r, n, o, i, s) {
                    ...
                    switch (o) {
                        ...
                        case 10:
                            ...
                            break;
                        case 11:
                            this.$ = n.prepareRawBlock(i[a - 2], i[a - 1], i[a], this._$);
                            break;
                        case 12:
                            this.$ = {
                                path: i[a - 3],
                            ...
                            break;
                        case 13:
                            this.$ = n.prepareBlock(i[a - 3], i[a - 2], i[a - 1], i[a], !1, this._$);
                            break;
                        case 14:
                            this.$ = n.prepareBlock(i[a - 3], i[a - 2], i[a - 1], i[a], !0, this._$);
                            break;
                        case 15:
                            this.$ = {
                                open: i[a - 5],
                        ...
                        case 18:
                            ...
                            break;
                        case 19:
                            var l = n.prepareBlock(i[a - 2], i[a - 1], i[a], i[a], !1, this._$),
                                u = n.prepareProgram([l], i[a - 1].loc);
                            u.chained = !0, this.$ = {
                                strip: i[a - 2].strip,
                                program: u,
                                chain: !0
                        ...
                        case 22:
                        case 23:
                            this.$ = n.prepareMustache(i[a - 3], i[a - 2], i[a - 1], i[a - 4], n.stripFlags(i[a - 4], i[a]), this._$);
                            break;
                        case 24:
                            this.$ = {
                            ...
                            break;
                        case 25:
                            this.$ = n.preparePartialBlock(i[a - 2], i[a - 1], i[a], this._$);
                            break;
                        case 26:
                            this.$ = {
                                path: i[a - 3],
                ...
                parse: function(e) {
                    ...
                    for (var p, h, f, d, g, m, v, _, y, S = {};;) {
                        if (h = r[r.length - 1], this.defaultActions[h] ? f = this.defaultActions[h] : (null == p && (y = void 0, "number" != typeof(y = t.lexer.lex() || 1) && (y = t.symbols_[y] || y), p = y), f = i[h] && i[h][p]), void 0 === f || !f.length || !f[0]) {
                            var k = "";
                            for (g in _ = [], i[h]) this.terminals_[g] && g > 2 && _.push("'" + this.terminals_[g] + "'");
                            k = this.lexer.showPosition ? "Parse error on line " + (a + 1) + ":\n" + this.lexer.showPosition() + "\nExpecting " + _.join(", ") + ", got '" + (this.terminals_[p] || p) + "'" : "Parse error on line " + (a + 1) + ": Unexpected " + (1 == p ? "end of input" : "'" + (this.terminals_[p] || p) + "'"), this.parseError(k, {
                        ...
                        switch (f[0]) {
                            case 1:
                                r.push(p), n.push(this.lexer.yytext), o.push(this.lexer.yylloc), r.push(f[1]), p = null, l = this.lexer.yyleng, s = this.lexer.yytext, a = this.lexer.yylineno, u = this.lexer.yylloc;
                                break;
                            case 2:
                                if (m = this.productions_[f[1]][1], S.$ = n[n.length - m], S._$ = {
                                        first_line: o[o.length - (m || 1)].first_line,
                                        last_line: o[o.length - 1].last_line,
                                        first_column: o[o.length - (m || 1)].first_column,
                                        last_column: o[o.length - 1].last_column
                                    }, c && (S._$.range = [o[o.length - (m || 1)].range[0], o[o.length - 1].range[1]]), void 0 !== (d = this.performAction.call(S, s, l, a, this.yy, f[1], n, o))) return d;
                                m && (r = r.slice(0, -1 * m * 2), n = n.slice(0, -1 * m), o = o.slice(0, -1 * m)), r.push(this.productions_[f[1]][0]), n.push(S.$), o.push(S._$), v = i[r[r.length - 2]][r[r.length - 1]], r.push(v);
                                break;
                            case 3:
                                return !0
                        }
            ...
            t = function() {
                var e = {
                    ...
                    next: function() {
                        ...
                        for (var i = this._currentRules(), s = 0; s < i.length && (!(r = this._input.match(this.rules[i[s]])) || t && !(r[0].length > t[0].length) || (t = r, n = s, this.options.flex)); s++);
...
! function(e, t) {
    ...
    n.prototype = {
        ...
        acceptKey: function(e, t) {
            var o = this.accept(e[t]);
            if (this.mutating) {
                if (o && !n.prototype[o.type]) throw new r.default('Unexpected node type "' + o.type + '" found when accepting ' + t + " on " + e.type);
                e[t] = o
            }
        },
...
! function(e, t) {
    ...
    function a(e, t, r) {
        ...
        if (n && "ContentStatement" === n.type && (r || !n.leftStripped)) {
            var o = n.value;
            return n.value = n.value.replace(r ? /\s+$/ : /[ \t]+$/, ""), n.leftStripped = n.value !== o, n.leftStripped
        }
    }
    n.prototype = new r.default, n.prototype.Program = function(e) {
        var t = !this.options.ignoreStandalone,
            r = !this.isRootSeen;
        this.isRootSeen = !0;
        for (var n = e.body, l = 0, u = n.length; l < u; l++) {
            var c = n[l],
                p = this.accept(c);
            if (p) {
                var h = o(n, l, r),
                ...
                p.close && s(n, l, !0), p.open && a(n, l, !0), t && m && (s(n, l), a(n, l) && "PartialStatement" === c.type && (c.indent = /([ \t]+$)/.exec(n[l - 1].original)[1])), t && d && (s((c.program || c.inverse).body), a(n, l)), t && g && (s(n, l), a((c.inverse || c.program).body))
            }
        }
        return e
        ...
        var t = e.program || e.inverse,
            ...
            l = r;
        if (r && r.chained)
            for (n = r.body[0].program; l.chained;) l = l.body[l.body.length - 1].program;
        var u = {
        ...
        if (e.openStrip.close && s(t.body, null, !0), r) {
            ...
            c.open && a(t.body, null, !0), c.close && s(n.body, null, !0), e.closeStrip.open && a(l.body, null, !0), !this.options.ignoreStandalone && o(t.body) && i(n.body) && (a(t.body), s(n.body))
...
We.__esModule = !0, We.Compiler = Ze, We.precompile = function(e, t, r) {
    ...
    function o() {
        var n = r.parse(e, t),
            o = (new r.Compiler).compile(n, t),
            i = (new r.JavaScriptCompiler).compile(o, t, void 0, !0);
        return r.template(i)
    }

    function i(e, t) {
        return n || (n = o()), n.call(this, e, t)
    }
    return i._setup = function(e) {
        return n || (n = o()), n._setup(e)
...
Ze.prototype = {
    ...
    PartialStatement: function(e) {
        ...
        var i = e.indent || "";
        this.options.preventIndent && i && (this.opcode("appendContent", i), i = ""), this.opcode("invokePartial", o, n, i), this.opcode("append")
    },
    PartialBlockStatement: function(e) {
    ...
    ambiguousSexpr: function(e, t, r) {
        var n = e.path,
            o = n.parts[0],
            i = null != t || null != r;
        this.opcode("getContext", n.depth), this.opcode("pushProgram", t), this.opcode("pushProgram", r), n.strict = !0, this.accept(n), this.opcode("invokeAmbiguous", o, i)
    },
    ...
    classifySexpr: function(e) {
        ...
        if (o && !n) {
            var i = e.path.parts[0],
                s = this.options;
            s.knownHelpers[i] ? n = !0 : s.knownHelpersOnly && (o = !1)
        }
    ...
    setupFullMustacheParams: function(e, t, r, n) {
        var o = e.params;
        return this.pushParams(o), this.opcode("pushProgram", t), this.opcode("pushProgram", r), e.hash ? this.accept(e.hash) : this.opcode("emptyHash", n), o
    },
...
function pt() {
    ...
    return lt.encode = function(t) {
        ...
        var o, i, s, a, l = t.length,
            ...
            c = 0;
        do {
            if (r >= l) throw new Error("Expected more digits in base 64 VLQ value.");
...
function dt() {
    return ht || (ht = 1, function(e) {
        ...
        function i(t) {
            ...
            for (var s, a = e.isAbsolute(r), l = r.split(/\/+/), u = 0, c = l.length - 1; c >= 0; c--) "." === (s = l[c]) ? l.splice(c, 1) : ".." === s ? u++ : u > 0 && ("" === s ? (l.splice(c + 1, u), u = 0) : (l.splice(c, 2), u--));
            return "" === (r = l.join("/")) && (r = a ? "/" : "."), i ? (i.path = r, o(i)) : r
        }
        ...
        function s(e, t) {
            ...
            var s = n(t),
                a = n(e);
            if (a && (e = a.path || "/"), s && !s.scheme) return a && (s.scheme = a.scheme), o(s);
            if (s || t.match(r)) return t;
            if (a && !a.host && !a.path) return a.host = t, o(a);
            var l = "/" === t.charAt(0) ? t : i(e.replace(/\/+$/, "") + "/" + t);
            return a ? (a.path = l, o(a)) : l
        }
        e.urlParse = n, e.urlGenerate = o, e.normalize = i, e.join = s, e.isAbsolute = function(e) {
        ...
        e.toSetString = a ? l : function(e) {
            ...
            var n = c(e.source, t.source);
            return 0 !== n || 0 !== (n = e.originalLine - t.originalLine) || 0 !== (n = e.originalColumn - t.originalColumn) || r || 0 !== (n = e.generatedColumn - t.generatedColumn) || 0 !== (n = e.generatedLine - t.generatedLine) ? n : c(e.name, t.name)
        }, e.compareByGeneratedPositionsDeflated = function(e, t, r) {
            var n = e.generatedLine - t.generatedLine;
            return 0 !== n || 0 !== (n = e.generatedColumn - t.generatedColumn) || r || 0 !== (n = c(e.source, t.source)) || 0 !== (n = e.originalLine - t.originalLine) || 0 !== (n = e.originalColumn - t.originalColumn) ? n : c(e.name, t.name)
...
function vt() {
    ...
    return n.fromArray = function(e, t) {
        for (var r = new n, o = 0, i = e.length; o < i; o++) r.add(e[o], t);
        return r
    }, n.prototype.size = function() {
        return r ? this._set.size : Object.getOwnPropertyNames(this._set).length
    }, n.prototype.add = function(n, o) {
        var i = r ? n : e.toSetString(n),
            s = r ? this.has(n) : t.call(this._set, i),
            a = this._array.length;
        s && !o || this._array.push(n), s || (r ? this._set.set(n, a) : this._set[i] = a)
...
function bt() {
    ...
    return o.prototype._version = 3, o.fromSourceMap = function(e) {
        var r = e.sourceRoot,
            n = new o({
                file: e.file,
                sourceRoot: r
        ...
        return e.eachMapping((function(e) {
            ...
            null != e.source && (o.source = e.source, null != r && (o.source = t.relative(r, o.source)), o.original = {
                line: e.originalLine,
                column: e.originalColumn
            }, null != e.name && (o.name = e.name)), n.addMapping(o)
        })), e.sources.forEach((function(o) {
            var i = o;
            null !== r && (i = t.relative(r, o)), n._sources.has(i) || n._sources.add(i);
            var s = e.sourceContentFor(o);
            null != s && n.setSourceContent(o, s)
        })), n
    }, o.prototype.addMapping = function(e) {
        var r = t.getArg(e, "generated"),
            n = t.getArg(e, "original", null),
            o = t.getArg(e, "source", null),
            i = t.getArg(e, "name", null);
        this._skipValidation || this._validateMapping(r, n, o, i), null != o && (o = String(o), this._sources.has(o) || this._sources.add(o)), null != i && (i = String(i), this._names.has(i) || this._names.add(i)), this._mappings.add({
    ...
    }, o.prototype.setSourceContent = function(e, r) {
        var n = e;
        null != this._sourceRoot && (n = t.relative(this._sourceRoot, n)), null != r ? (this._sourcesContents || (this._sourcesContents = Object.create(null)), this._sourcesContents[t.toSetString(n)] = r) : this._sourcesContents && (delete this._sourcesContents[t.toSetString(n)], 0 === Object.keys(this._sourcesContents).length && (this._sourcesContents = null))
    }, o.prototype.applySourceMap = function(e, n, o) {
        var i = n;
        if (null == n) {
        ...
        null != s && (i = t.relative(s, i));
        var a = new r,
            l = new r;
        this._mappings.unsortedForEach((function(r) {
            if (r.source === i && null != r.originalLine) {
                var n = e.originalPositionFor({
                    line: r.originalLine,
                    column: r.originalColumn
                });
                null != n.source && (r.source = n.source, null != o && (r.source = t.join(o, r.source)), null != s && (r.source = t.relative(s, r.source)), r.originalLine = n.line, r.originalColumn = n.column, null != n.name && (r.name = n.name))
            }
            var u = r.source;
            null == u || a.has(u) || a.add(u);
            var c = r.name;
            null == c || l.has(c) || l.add(c)
        }), this), this._sources = a, this._names = l, e.sources.forEach((function(r) {
            var n = e.sourceContentFor(r);
            null != n && (null != o && (r = t.join(o, r)), null != s && (r = t.relative(s, r)), this.setSourceContent(r, n))
        }), this)
        ...
        for (var r, n, o, i, s = 0, a = 1, l = 0, u = 0, c = 0, p = 0, h = "", f = this._mappings.toArray(), d = 0, g = f.length; d < g; d++) {
            if (r = "", (n = f[d]).generatedLine !== a)
                for (s = 0; n.generatedLine !== a;) r += ";", a++;
            else if (d > 0) {
                if (!t.compareByGeneratedPositionsInflated(n, f[d - 1])) continue;
                r += ","
            }
            r += e.encode(n.generatedColumn - s), s = n.generatedColumn, null != n.source && (i = this._sources.indexOf(n.source), r += e.encode(i - p), p = i, r += e.encode(n.originalLine - 1 - u), u = n.originalLine - 1, r += e.encode(n.originalColumn - l), l = n.originalColumn, null != n.name && (o = this._names.indexOf(n.name), r += e.encode(o - c), c = o)), h += r
        }
        return h
    }, o.prototype._generateSourcesContent = function(e, r) {
    ...
    return Pt || (Pt = 1, function(e) {
        function t(r, n, o, i, s, a) {
            var l = Math.floor((n - r) / 2) + r,
                u = s(o, i[l], !0);
            return 0 === u ? l : u > 0 ? n - l > 1 ? t(l, n, o, i, s, a) : a == e.LEAST_UPPER_BOUND ? n < i.length ? n : -1 : l : l - r > 1 ? t(r, l, o, i, s, a) : a == e.LEAST_UPPER_BOUND ? l : r < 0 ? -1 : r
        }
        e.GREATEST_LOWER_BOUND = 1, e.LEAST_UPPER_BOUND = 2, e.search = function(r, n, o, i) {
            if (0 === n.length) return -1;
            var s = t(-1, n.length, r, n, o, i || e.GREATEST_LOWER_BOUND);
            if (s < 0) return -1;
...
function Ot() {
    ...
    function t(r, n, o, i) {
        if (o < i) {
            var s = o - 1;
            e(r, (c = o, p = i, Math.round(c + Math.random() * (p - c))), i);
            for (var a = r[i], l = o; l < i; l++) n(r[l], a) <= 0 && e(r, s += 1, l);
            e(r, s + 1, l);
            var u = s + 1;
            t(r, n, o, u - 1), t(r, n, u + 1, i)
        }
        var c, p
    }
...
function Rt() {
    return It || (It = 1, st.SourceMapGenerator = bt().SourceMapGenerator, st.SourceMapConsumer = function() {
        ...
        function i(t, r) {
            var n = t;
            return "string" == typeof t && (n = e.parseSourceMapInput(t)), null != n.sections ? new l(n, r) : new s(n, r)
        }
        ...
        function s(t, n) {
            ...
            var i = e.getArg(o, "version"),
                ...
                a = e.getArg(o, "names", []),
                l = e.getArg(o, "sourceRoot", null),
                u = e.getArg(o, "sourcesContent", null),
                c = e.getArg(o, "mappings"),
                p = e.getArg(o, "file", null);
            if (i != this._version) throw new Error("Unsupported version: " + i);
            l && (l = e.normalize(l)), s = s.map(String).map(e.normalize).map((function(t) {
                return l && e.isAbsolute(l) && e.isAbsolute(t) ? e.relative(l, t) : t
            })), this._names = r.fromArray(a.map(String), !0), this._sources = r.fromArray(s, !0), this._absoluteSources = this._sources.toArray().map((function(t) {
                return e.computeSourceURL(l, t, n)
            })), this.sourceRoot = l, this.sourcesContent = u, this._mappings = c, this._sourceMapURL = n, this.file = p
        }
        ...
        function l(t, n) {
            ...
            this._sections = a.map((function(t) {
                if (t.url) throw new Error("Support for url field in sections not implemented.");
                var r = e.getArg(t, "offset"),
                    o = e.getArg(r, "line"),
                    s = e.getArg(r, "column");
                if (o < l.line || o === l.line && s < l.column) throw new Error("Section offsets must be ordered and non-overlapping.");
                return l = r, {
                    generatedOffset: {
                        generatedLine: o + 1,
                        generatedColumn: s + 1
                    },
                    consumer: new i(e.getArg(t, "map"), n)
                }
            }))
        }
        return i.fromSourceMap = function(e, t) {
        ...
        }, i.GENERATED_ORDER = 1, i.ORIGINAL_ORDER = 2, i.GREATEST_LOWER_BOUND = 1, i.LEAST_UPPER_BOUND = 2, i.prototype.eachMapping = function(t, r, n) {
            var o, s = r || null;
            ...
            var i = [],
                s = this._findMapping(o, this._originalMappings, "originalLine", "originalColumn", e.compareByOriginalPositions, t.LEAST_UPPER_BOUND);
            if (s >= 0) {
                var a = this._originalMappings[s];
                if (void 0 === r.column)
                    for (var l = a.originalLine; a && a.originalLine === l;) i.push({
                    ...
                    for (var u = a.originalColumn; a && a.originalLine === n && a.originalColumn == u;) i.push({
                        line: e.getArg(a, "generatedLine", null),
                        column: e.getArg(a, "generatedColumn", null),
                        lastColumn: e.getArg(a, "lastGeneratedColumn", null)
                    }), a = this._originalMappings[++s]
            ...
            return -1
        }, s.fromSourceMap = function(t, n) {
            var i = Object.create(s.prototype),
                l = i._names = r.fromArray(t._names.toArray(), !0),
                u = i._sources = r.fromArray(t._sources.toArray(), !0);
            i.sourceRoot = t._sourceRoot, i.sourcesContent = t._generateSourcesContent(i._sources.toArray(), i.sourceRoot), i.file = t._file, i._sourceMapURL = n, i._absoluteSources = i._sources.toArray().map((function(t) {
                return e.computeSourceURL(i.sourceRoot, t, n)
            }));
            for (var c = t._mappings.toArray().slice(), p = i.__generatedMappings = [], h = i.__originalMappings = [], f = 0, d = c.length; f < d; f++) {
                var g = c[f],
                    m = new a;
                m.generatedLine = g.generatedLine, m.generatedColumn = g.generatedColumn, g.source && (m.source = u.indexOf(g.source), m.originalLine = g.originalLine, m.originalColumn = g.originalColumn, g.name && (m.name = l.indexOf(g.name)), h.push(m)), p.push(m)
            }
        ...
        }), s.prototype._parseMappings = function(t, r) {
            for (var i, s, l, u, c, p = 1, h = 0, f = 0, d = 0, g = 0, m = 0, v = t.length, _ = 0, y = {}, S = {}, k = [], b = []; _ < v;)
                if (";" === t.charAt(_)) p++, _++, h = 0;
                else if ("," === t.charAt(_)) _++;
            else {
                for ((i = new a).generatedLine = p, u = _; u < v && !this._charIsMappingSeparator(t, u); u++);
                if (l = y[s = t.slice(_, u)]) _ += s.length;
                else {
                    for (l = []; _ < u;) n.decode(t, _, S), c = S.value, _ = S.rest, l.push(c);
                    if (2 === l.length) throw new Error("Found a source, but no line and column");
                    if (3 === l.length) throw new Error("Found a source and line, but no column");
                    y[s] = l
                }
                i.generatedColumn = h + l[0], h = i.generatedColumn, l.length > 1 && (i.source = g + l[1], g += l[1], i.originalLine = f + l[2], f = i.originalLine, i.originalLine += 1, i.originalColumn = d + l[3], d = i.originalColumn, l.length > 4 && (i.name = m + l[4], m += l[4])), b.push(i), "number" == typeof i.originalLine && k.push(i)
            }
            o(b, e.compareByGeneratedPositionsDeflated), this.__generatedMappings = b, o(k, e.compareByOriginalPositions), this.__originalMappings = k
        }, s.prototype._findMapping = function(e, r, n, o, i, s) {
            ...
            var r = {
                ...
                n = this._findMapping(r, this._generatedMappings, "generatedLine", "generatedColumn", e.compareByGeneratedPositionsDeflated, e.getArg(t, "bias", i.GREATEST_LOWER_BOUND));
            if (n >= 0) {
                var o = this._generatedMappings[n];
                if (o.generatedLine === r.generatedLine) {
                    var s = e.getArg(o, "source", null);
                    null !== s && (s = this._sources.at(s), s = e.computeSourceURL(this.sourceRoot, s, this._sourceMapURL));
        ...
        }, s.prototype.sourceContentFor = function(t, r) {
            if (!this.sourcesContent) return null;
            var n = this._findSourceIndex(t);
            if (n >= 0) return this.sourcesContent[n];
            var o, i = t;
            if (null != this.sourceRoot && (i = e.relative(this.sourceRoot, i)), null != this.sourceRoot && (o = e.urlParse(this.sourceRoot))) {
            ...
            var r = e.getArg(t, "source");
            if ((r = this._findSourceIndex(r)) < 0) return {
                line: null,
                column: null,
                lastColumn: null
            };
            var n = {
                ...
                o = this._findMapping(n, this._originalMappings, "originalLine", "originalColumn", e.compareByOriginalPositions, e.getArg(t, "bias", i.GREATEST_LOWER_BOUND));
            if (o >= 0) {
            ...
            var n = {
                ...
                o = t.search(n, this._sections, (function(e, t) {
            ...
            for (var r = 0; r < this._sections.length; r++) {
                ...
                if (-1 !== n.consumer._findSourceIndex(e.getArg(t, "source"))) {
                    var o = n.consumer.generatedPositionFor(t);
                    if (o) return {
            ...
            for (var n = 0; n < this._sections.length; n++)
                for (var i = this._sections[n], s = i.consumer._generatedMappings, a = 0; a < s.length; a++) {
                    var l = s[a],
                        u = i.consumer._sources.at(l.source);
                    u = e.computeSourceURL(i.consumer.sourceRoot, u, this._sourceMapURL), this._sources.add(u), u = this._sources.indexOf(u);
                    var c = null;
        ...
        function o(e, t, r, o, i) {
            this.children = [], this.sourceContents = {}, this.line = null == e ? null : e, this.column = null == t ? null : t, this.source = null == r ? null : r, this.name = null == i ? null : i, this[n] = !0, null != o && this.add(o)
        }
        return o.fromStringWithSourceMap = function(e, n, i) {
            var s = new o,
                a = e.split(r),
                l = 0,
                u = function() {
            ...
            return n.eachMapping((function(e) {
                if (null !== h) {
                    if (!(c < e.generatedLine)) {
                        var t = (r = a[l] || "").substr(0, e.generatedColumn - p);
                        return a[l] = r.substr(e.generatedColumn - p), p = e.generatedColumn, f(h, t), void(h = e)
                    }
                    f(h, u()), c++, p = 0
                }
                ...
                if (p < e.generatedColumn) {
                    var r = a[l] || "";
                    s.add(r.substr(0, e.generatedColumn)), a[l] = r.substr(e.generatedColumn), p = e.generatedColumn
                }
                h = e
            }), this), l < a.length && (h && f(h, u()), s.add(a.splice(l).join(""))), n.sources.forEach((function(e) {
                var r = n.sourceContentFor(e);
                null != r && (null != i && (e = t.join(i, e)), s.setSourceContent(e, r))
            })), s;

            function f(e, r) {
                if (null === e || void 0 === e.source) s.add(r);
                else {
                    var n = i ? t.join(i, e.source) : e.source;
                    s.add(new o(e.originalLine, e.originalColumn, n, r, e.name))
                }
            }
            ...
            if (Array.isArray(e)) e.forEach((function(e) {
                ...
                if (!e[n] && "string" != typeof e) throw new TypeError("Expected a SourceNode, string, or an array of SourceNodes and strings. Got " + e);
            ...
            for (var t, r = 0, o = this.children.length; r < o; r++)(t = this.children[r])[n] ? t.walk(e) : "" !== t && e(t, {
                source: this.source,
                line: this.line,
                column: this.column,
                name: this.name
            ...
            return r[n] ? r.replaceRight(e, t) : "string" == typeof r ? this.children[this.children.length - 1] = r.replace(e, t) : this.children.push("".replace(e, t)), this
        }, o.prototype.setSourceContent = function(e, r) {
            this.sourceContents[t.toSetString(e)] = r
        }, o.prototype.walkSourceContents = function(e) {
            for (var r = 0, o = this.children.length; r < o; r++) this.children[r][n] && this.children[r].walkSourceContents(e);
            var i = Object.keys(this.sourceContents);
            for (r = 0, o = i.length; r < o; r++) e(t.fromSetString(i[r]), this.sourceContents[i[r]])
        }, o.prototype.toString = function() {
            var e = "";
            return this.walk((function(t) {
                e += t
            })), e
        }, o.prototype.toStringWithSourceMap = function(t) {
            var r = {
                    code: "",
                    line: 1,
                    column: 0
            ...
            return this.walk((function(e, t) {
                r.code += e, null !== t.source && null !== t.line && null !== t.column ? (i === t.source && s === t.line && a === t.column && l === t.name || n.addMapping({
                    source: t.source,
                    original: {
                        line: t.line,
                        column: t.column
                    ...
                    name: t.name
                }), i = t.source, s = t.line, a = t.column, l = t.name, o = !0) : o && (n.addMapping({
                    generated: {
                        line: r.line,
                        column: r.column
                    }
                }), i = null, o = !1);
                for (var u = 0, c = e.length; u < c; u++) 10 === e.charCodeAt(u) ? (r.line++, r.column = 0, u + 1 === c ? (i = null, o = !1) : o && n.addMapping({
                    source: t.source,
                    original: {
                        line: t.line,
                        column: t.column
    ...
    function i(e, t, n) {
        if (r.isArray(e)) {
            for (var o = [], i = 0, s = e.length; i < s; i++) o.push(t.wrap(e[i], n));
            return o
        }
    ...
    n || ((n = function(e, t, r, n) {
        ...
        generateList: function(e) {
            for (var t = this.empty(), r = 0, n = e.length; r < n; r++) r && t.add(","), t.add(i(e[r], this));
            return t
        },
    ...
    c.prototype = {
            ...
            compile: function(e, t, r, n) {
                ...
                var h = this.context,
                    f = h.programs,
                    d = h.decorators;
                for (l = 0, u = f.length; l < u; l++) f[l] && (p[l] = f[l], d[l] && (p[l + "_d"] = d[l], p.useDecorators = !0));
            ...
            createFunctionContext: function(e) {
                ...
                Object.keys(this.aliases).forEach((function(e) {
                    var n = t.aliases[e];
                    n.children && n.referenceCount > 1 && (r += ", alias" + ++o + "=" + e, n.children[0] = "alias" + o)
            ...
            mergeSource: function(e) {
                ...
                return this.source.each((function(e) {
                    e.appendToBuffer ? (i ? e.prepend("  + ") : i = e, s = e) : (i && (o ? i.prepend("buffer += ") : n = !0, s.add(";"), i = s = void 0), o = !0, t || (r = !1))
                })), r ? i ? (i.prepend("return "), s.add(";")) : o || this.source.push('return "";') : (e += ", buffer = " + (n ? "" : this.initializeBuffer()), i ? (i.prepend("return buffer + "), s.add(";")) : this.source.push("return buffer;")), e && this.source.prepend("var " + e.substring(2) + (n ? "" : ";\n")), this.source.merge()
            },
            ...
            lookupOnContext: function(e, t, r, n) {
                var o = 0;
                n || !this.options.compat || this.lastContext ? this.pushContext() : this.push(this.depthedLookup(e[o++])), this.resolvePath("context", e, o, t, r)
            },
            ...
            resolvePath: function(e, t, r, n, o) {
                var i = this;
                if (this.options.strict || this.options.assumeObjects) this.push(function(e, t, r, n) {
                    var o = t.popStack(),
                        ...
                        s = r.length;
                    e && s--;
                    for (; i < s; i++) o = t.nameLookup(o, r[i], n);
                    return e ? [t.aliasable("container.strict"), "(", o, ", ", t.quotedString(r[i]), ", ", JSON.stringify(t.source.currentLocation), " )"] : o
                }(this.options.strict && o, this, t, e));
                else
                    for (var s = t.length; r < s; r++) this.replaceStack((function(o) {
                        var s = i.nameLookup(o, t[r], e);
                        return n ? [" && ", s] : [" != null ? ", s, " : ", o]
                    }))
            },
            ...
            invokeAmbiguous: function(e, t) {
                ...
                var n = this.setupHelper(0, e, t),
                    o = ["(", "(helper = ", this.lastHelper = this.nameLookup("helpers", e, "helper"), " || ", r, ")"];
            ...
            assignToHash: function(e) {
                ...
                var i = this.hash;
                r && (i.contexts[e] = r), n && (i.types[e] = n), o && (i.ids[e] = o), i.values[e] = t
            },
            ...
            compileChildren: function(e, t) {
                for (var r = e.children, n = void 0, o = void 0, i = 0, s = r.length; i < s; i++) {
                    n = r[i], o = new this.compiler;
            ...
            push: function(e) {
                return e instanceof u || (e = this.source.wrap(e)), this.inlineStack.push(e), e
            },
            ...
            replaceStack: function(e) {
                ...
                if (s instanceof u) t = ["(", r = [s.value]], i = !0;
                else {
                    n = !0;
                ...
                var l = e.call(this, r);
                i || this.popStack(), n && this.stackSlot--, this.push(t.concat(l, ")"))
            },
            incrStack: function() {
            ...
            flushInline: function() {
                ...
                for (var t = 0, r = e.length; t < r; t++) {
                    var n = e[t];
                    if (n instanceof u) this.compileStack.push(n);
                    else {
            ...
            popStack: function(e) {
                ...
                if (!e && r instanceof u) return r.value;
                if (!t) {
            ...
            setupParams: function(e, t, r) {
                ...
                return a && (n.args = this.source.generateArray(r)), this.trackIds && (n.ids = this.source.generateArray(s)), this.stringParams && (n.types = this.source.generateArray(i), n.contexts = this.source.generateArray(o)), this.options.data && (n.data = "data"), this.useBlockParams && (n.blockParams = "blockParams"), n
            },
            setupHelperArgs: function(e, t, r, n) {
                var o = this.setupParams(e, t, r);
                return o.loc = JSON.stringify(this.source.currentLocation), o = this.objectLiteral(o), n ? (this.useRegister("options"), r.push("options"), ["options=", o]) : r ? (r.push(o), "") : o
            }
        },
        function() {
            for (var e = "break else new var case finally return void catch for switch while continue function this with default if throw delete in try do instanceof typeof abstract enum int short boolean export interface static byte extends long super char final native synchronized class float package throws const goto private transient debugger implements protected volatile double import public let yield await null true false".split(" "), t = c.RESERVED_WORDS = {}, r = 0, n = e.length; r < n; r++) t[e[r]] = !0
...
! function(e, t) {
    ...
    function p() {
        ...
        return e.compile = function(t, r) {
            return s.compile(t, r, e)
        }, e.precompile = function(t, r) {
            return s.precompile(t, r, e)
        }, e.AST = o.default, e.Compiler = s.Compiler, e.JavaScriptCompiler = a.default, e.Parser = i.parser, e.parse = i.parse, e.parseWithoutProcessing = i.parseWithoutProcessing, e
    }
    var h = p();
