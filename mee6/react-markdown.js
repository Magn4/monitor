...
function a(e) {
    return e && "object" == typeof e ? "position" in e || "type" in e ? s(e.position) : "start" in e || "end" in e ? s(e) : "line" in e || "column" in e ? c(e) : "" : ""
}
...
class p extends Error {
    constructor(e, n, t) {
        ...
        n && ("type" in n || "position" in n ? n.position && (o = n.position) : "start" in n || "end" in n ? o = n : ("line" in n || "column" in n) && (o.start = n)), this.name = a(n) || "1:1", this.message = "object" == typeof e ? e.message : e, this.stack = "", "object" == typeof e && e.stack && (this.stack = e.stack), this.reason = this.message, this.fatal, this.line = o.start.line, this.column = o.start.column, this.position = o, this.source = r[0], this.ruleId = r[1], this.file, this.actual, this.expected, this.url, this.note
    }
}
...
class x {
    constructor(e) {
        ...
        n = e ? "string" == typeof e || function(e) {
            ...
            path: e
        } : e : {}, this.data = {}, this.messages = [], this.history = [], this.cwd = m.cwd(), this.value, this.stored, this.result, this.map;
        let t, r = -1;
        for (; ++r < k.length;) {
            const e = k[r];
    ...
    set path(e) {
        g(e) && (e = y(e)), b(e, "path"), this.path !== e && this.history.push(e)
    }
    get dirname() {
        return "string" == typeof this.path ? d.dirname(this.path) : void 0
    }
    set dirname(e) {
        w(this.basename, "dirname"), this.path = d.join(e || "", this.basename)
    }
    get basename() {
...
function v(e, n) {
    if (e && e.includes(d.sep)) throw new Error("`" + n + "` cannot be a path: did not expect `" + d.sep + "`")
}
...
const A = function e() {
        ...
        return a.data = function(e, n) {
            if ("string" == typeof e) return 2 === arguments.length ? (I("data", r), l[e] = n, a) : F.call(l, e) && l[e] || null;
            if (e) return I("data", r), l = e, a;
            return l
            ...
            return r = !0, u = Number.POSITIVE_INFINITY, a
        }, a.attachers = t, a.use = function(e, ...n) {
            let o;
            if (I("use", r), null == e);
            ...
            o && (l.settings = Object.assign(l.settings || {}, o));
            return a;
            ...
            function c(e) {
                s(e.plugins), e.settings && (o = Object.assign(o || {}, e.settings))
            }
            ...
            function f(e, n) {
                ...
                for (; ++o < t.length;)
                    if (t[o][0] === e) {
                        r = t[o];
                        break
                    } r ? (E(r[1]) && E(n) && (n = i(!0, r[1], n)), r[1] = n) : t.push([...arguments])
            }
        }, a.parse = function(e) {
            a.freeze();
            const n = z(e),
                t = a.Parser;
            if (D("parse", t), T(t, "parse")) return new t(String(n), n).parse();
            return t(String(n), n)
        }, a.stringify = function(e, n) {
            a.freeze();
            const t = z(n),
                r = a.Compiler;
            if (P("stringify", r), O(e), T(r, "compile")) return new r(e, t).compile();
            return r(e, t)
        }, a.run = function(e, t, r) {
            O(e), a.freeze(), r || "function" != typeof t || (r = t, t = void 0);
            ...
            let t, r;
            return a.run(e, n, o), L("runSync", "run", r), t;

            function o(e, n) {
                S(e), t = n, r = !0
            }
        }, a.process = function(e, n) {
            if (a.freeze(), D("process", a.Parser), P("process", a.Compiler), !n) return new Promise(t);
            ...
            function t(t, r) {
                ...
                a.run(a.parse(i), i, ((e, n, t) => {
                    if (!e && n && t) {
                        const i = a.stringify(n, t);
                        null == i || ("string" == typeof(r = i) || o(r) ? t.value = i : t.result = i), l(e, t)
                    } else l(e);
                    var r
                }))
            }
            ...
            let n;
            a.freeze(), D("processSync", a.Parser), P("processSync", a.Compiler);
            const t = z(e);
            return a.process(t, r), L("processSync", "process", n), t;
...
function j(e, n) {
    return e.length > 0 ? (N(e, e.length, 0, n), e) : n
}
        ...
        tokenize: function(e) {
            ...
            function a(e) {
                if (l++, n.containerState._closeFlow) {
                    ...
                    return N(n.events, i + 1, 0, n.events.slice(t)), n.events.length = u, c(e)
                }
                return u(e)
            }
            ...
            function g(e, t) {
                ...
                if (t && u.push(null), e.previous = o, o && (o.next = e), o = e, r.defineSkip(e.start), r.write(u), n.parser.lazy[e.start.line]) {
                    ...
                    N(n.events, a + 1, 0, n.events.slice(t)), n.events.length = e
                }
            }
            ...
            if ("enter" === e[s][0] && "attentionSequence" === e[s][1].type && e[s][1]._close)
                for (t = s; t--;)
                    if ("exit" === e[t][0] && "attentionSequence" === e[t][1].type && e[t][1]._open && n.sliceSerialize(e[t][1]).charCodeAt(0) === n.sliceSerialize(e[s][1]).charCodeAt(0)) {
                        ...
                        ce(f, -u), ce(p, u), i = {
                        ...
                        }, e[t][1].end = Object.assign({}, i.start), e[s][1].start = Object.assign({}, l.end), a = [], e[t][1].end.offset - e[t][1].start.offset && (a = j(a, [
                            ["enter", e[t][1], n],
                            ["exit", e[t][1], n]
                        ])), a = j(a, [
                            ["enter", r, n],
                            ...
                            ["exit", i, n],
                            ["enter", o, n]
                        ]), a = j(a, ue(n.parser.constructs.insideSpan.null, e.slice(t + 1, s), n)), a = j(a, [
                            ["exit", o, n],
                            ["enter", l, n],
                            ["exit", l, n],
                            ["exit", r, n]
                        ]), e[s][1].end.offset - e[s][1].start.offset ? (c = 2, a = j(a, [
                            ["enter", e[s][1], n],
                            ["exit", e[s][1], n]
                        ])) : c = 0, N(e, t - 1, s - t + 3, a), s = t + a.length - c - 2;
                        break
                    } s = -1;
...
const se = {
    ...
    tokenize: function(e, n, t) {
        ...
        function o(n) {
            return q(n) ? (e.consume(n), i) : a(n)
        }

        function i(e) {
            return 43 === e || 45 === e || 46 === e || V(e) ? (r = 1, l(e)) : a(e)
        }

        function l(n) {
            return 58 === n ? (e.consume(n), r = 0, u) : (43 === n || 45 === n || 46 === n || V(n)) && r++ < 32 ? (e.consume(n), l) : (r = 0, a(n))
        }

        function u(r) {
            return 62 === r ? (e.exit("autolinkProtocol"), e.enter("autolinkMarker"), e.consume(r), e.exit("autolinkMarker"), e.exit("autolink"), n) : null === r || 32 === r || 60 === r || Q(r) ? t(r) : (e.consume(r), u)
        }

        function a(n) {
            return 64 === n ? (e.consume(n), c) : W(n) ? (e.consume(n), a) : t(n)
        }
...
const ge = {
    ...
    tokenize: function(e, n, t) {
        ...
        function u(n) {
            return 35 === n ? (e.enter("characterReferenceMarkerNumeric"), e.consume(n), e.exit("characterReferenceMarkerNumeric"), a) : (e.enter("characterReferenceValue"), o = 31, i = V, c(n))
        }

        function a(n) {
            return 88 === n || 120 === n ? (e.enter("characterReferenceMarkerHexadecimal"), e.consume(n), e.exit("characterReferenceMarkerHexadecimal"), e.enter("characterReferenceValue"), o = 6, i = Y, c) : (e.enter("characterReferenceValue"), o = 7, i = $, c(n))
        }

        function c(u) {
            if (59 === u && l) {
                const o = e.exit("characterReferenceValue");
                return i !== V || me(r.sliceSerialize(o)) ? (e.enter("characterReferenceMarker"), e.consume(u), e.exit("characterReferenceMarker"), e.exit("characterReference"), n) : t(u)
            }
...
const ye = {
    ...
    ke = {
        ...
        tokenize: function(e, n, t) {
            ...
            function c(t) {
                return null === t || X(t) ? (e.exit("codeFencedFence"), r.interrupt ? n(t) : e.check(ye, d, k)(t)) : (e.enter("codeFencedFenceInfo"), e.enter("chunkString", {
                    contentType: "string"
                }), s(t))
            }
            ...
            function g(n) {
                return null === n || X(n) ? e.check(ye, d, k)(n) : (e.enter("codeFlowValue"), y(n))
            }
...
const xe = {
        ...
        tokenize: function(e, n, t) {
            ...
            function i(n) {
                return null === n ? u(n) : X(n) ? e.attempt(ve, i, u)(n) : (e.enter("codeFlowValue"), l(n))
            }
...
function we(e) {
    ...
    for (; ++c < e.length;) {
        ...
        if ("enter" === t[0]) t[1].contentType && (Object.assign(n, Se(e, c)), c = n[c], a = !0);
            ...
            r && (t[1].end = Object.assign({}, e[r][1].start), l = e.slice(r, c), l.unshift(t), N(e, r, c - r + 1, l))
        }
    }
    return !a
}
...
function Se(e, n) {
    ...
    for (l.events = [], d ? (d._tokenizer = void 0, d.previous = void 0) : g.pop(), p = g.length; p--;) {
        const n = u.slice(g[p], g[p + 1]),
            t = i.pop();
        a.unshift([t, t + n.length - 1]), N(e, t, 2, n)
    }
...
const Ee = {
        tokenize: function(e, n) {
            ...
            function r(n) {
                return null === n ? o(n) : X(n) ? e.check(Ce, i, o)(n) : (e.consume(n), r)
            }
...
function Ae(e, n, t, r, o, i, l, u, a) {
    ...
    function h(o) {
        return s || null !== o && 41 !== o && !Z(o) ? s < c && 40 === o ? (e.consume(o), s++, h) : 41 === o ? (e.consume(o), s--, h) : null === o || 32 === o || 40 === o || Q(o) ? t(o) : (e.consume(o), 92 === o ? m : h) : (e.exit("chunkString"), e.exit(u), e.exit(l), e.exit(r), n(o))
    }
...
const Ie = {
        ...
        tokenize: function(e, n, t) {
            ...
            return function(n) {
                return e.enter("definition"),
                    function(n) {
                        return Fe.call(r, e, i, t, "definitionLabel", "definitionLabelMarker", "definitionLabelString")(n)
                    }(n)
            };
            ...
            function l(n) {
                return Z(n) ? De(e, u)(n) : u(n)
            }

            function u(n) {
                return Ae(e, a, t, "definitionDestination", "definitionDestinationLiteral", "definitionDestinationLiteralMarker", "definitionDestinationRaw", "definitionDestinationString")(n)
            }
    ...
    Oe = {
        tokenize: function(e, n, t) {
            return function(n) {
                return Z(n) ? De(e, r)(n) : t(n)
            };

            function r(n) {
                return Te(e, o, t, "definitionTitle", "definitionTitleMarker", "definitionTitleString")(n)
            }
...
const Me = ["address", "article", "aside", "base", "basefont", "blockquote", "body", "caption", "center", "col", "colgroup", "dd", "details", "dialog", "dir", "div", "dl", "dt", "fieldset", "figcaption", "figure", "footer", "form", "frame", "frameset", "h1", "h2", "h3", "h4", "h5", "h6", "head", "header", "hr", "html", "iframe", "legend", "li", "link", "main", "menu", "menuitem", "nav", "noframes", "ol", "optgroup", "option", "p", "param", "search", "section", "summary", "table", "tbody", "td", "tfoot", "th", "thead", "title", "tr", "track", "ul"],
    ...
    Be = {
        ...
        tokenize: function(e, n, t) {
            ...
            function c(u) {
                return 33 === u ? (e.consume(u), s) : 47 === u ? (e.consume(u), i = !0, d) : 63 === u ? (e.consume(u), o = 3, r.interrupt ? n : z) : q(u) ? (e.consume(u), l = String.fromCharCode(u), h) : t(u)
            }

            function s(i) {
                return 45 === i ? (e.consume(i), o = 2, f) : 91 === i ? (e.consume(i), o = 5, u = 0, p) : q(i) ? (e.consume(i), o = 4, r.interrupt ? n : z) : t(i)
            }
            ...
            function d(n) {
                return q(n) ? (e.consume(n), l = String.fromCharCode(n), h) : t(n)
            }
            ...
            function h(u) {
                if (null === u || 47 === u || 62 === u || Z(u)) {
                    const a = 47 === u,
                        c = l.toLowerCase();
                    return a || i || !Re.includes(c) ? Me.includes(l.toLowerCase()) ? (o = 6, a ? (e.consume(u), m) : r.interrupt ? n(u) : A(u)) : (o = 7, r.interrupt && !r.parser.lazy[r.now().line] ? t(u) : i ? g(u) : y(u)) : (o = 1, r.interrupt ? n(u) : A(u))
                }
                return 45 === u || V(u) ? (e.consume(u), l += String.fromCharCode(u), h) : t(u)
            }
            ...
            function y(n) {
                return 47 === n ? (e.consume(n), E) : 58 === n || 95 === n || q(n) ? (e.consume(n), k) : J(n) ? (e.consume(n), y) : E(n)
            }

            function k(n) {
                return 45 === n || 46 === n || 58 === n || 95 === n || V(n) ? (e.consume(n), k) : x(n)
            }
            ...
            function A(n) {
                return 45 === n && 2 === o ? (e.consume(n), P) : 60 === n && 1 === o ? (e.consume(n), I) : 62 === n && 4 === o ? (e.consume(n), M) : 63 === n && 3 === o ? (e.consume(n), z) : 93 === n && 5 === o ? (e.consume(n), L) : !X(n) || 6 !== o && 7 !== o ? null === n || X(n) ? (e.exit("htmlFlowData"), F(n)) : (e.consume(n), A) : (e.exit("htmlFlowData"), e.check(Ne, R, F)(n))
            }
            ...
            function I(n) {
                return 47 === n ? (e.consume(n), l = "", O) : A(n)
            }

            function O(n) {
                if (62 === n) {
                    const t = l.toLowerCase();
                    return Re.includes(t) ? (e.consume(n), M) : A(n)
                }
                return q(n) && l.length < 8 ? (e.consume(n), l += String.fromCharCode(n), O) : A(n)
            }
    ...
    Ne = {
        tokenize: function(e, n, t) {
            return function(r) {
                return e.enter("lineEnding"), e.consume(r), e.exit("lineEnding"), e.attempt(fe, n, t)
            }
        },
        partial: !0
    },
...
const _e = {
    ...
    tokenize: function(e, n, t) {
        ...
        function u(n) {
            return 33 === n ? (e.consume(n), a) : 47 === n ? (e.consume(n), v) : 63 === n ? (e.consume(n), k) : q(n) ? (e.consume(n), S) : t(n)
        }

        function a(n) {
            return 45 === n ? (e.consume(n), c) : 91 === n ? (e.consume(n), i = 0, d) : q(n) ? (e.consume(n), y) : t(n)
        }
        ...
        function s(n) {
            return null === n ? t(n) : 45 === n ? (e.consume(n), f) : X(n) ? (l = s, O(n)) : (e.consume(n), s)
        }
        ...
        function h(n) {
            return null === n ? t(n) : 93 === n ? (e.consume(n), m) : X(n) ? (l = h, O(n)) : (e.consume(n), h)
        }
        ...
        function g(n) {
            return 62 === n ? I(n) : 93 === n ? (e.consume(n), g) : h(n)
        }

        function y(n) {
            return null === n || 62 === n ? I(n) : X(n) ? (l = y, O(n)) : (e.consume(n), y)
        }

        function k(n) {
            return null === n ? t(n) : 63 === n ? (e.consume(n), x) : X(n) ? (l = k, O(n)) : (e.consume(n), k)
        }
        ...
        function v(n) {
            return q(n) ? (e.consume(n), b) : t(n)
        }

        function b(n) {
            return 45 === n || V(n) ? (e.consume(n), b) : w(n)
        }

        function w(n) {
            return X(n) ? (l = w, O(n)) : J(n) ? (e.consume(n), w) : I(n)
        }

        function S(n) {
            return 45 === n || V(n) ? (e.consume(n), S) : 47 === n || 62 === n || Z(n) ? E(n) : t(n)
        }

        function E(n) {
            return 47 === n ? (e.consume(n), I) : 58 === n || 95 === n || q(n) ? (e.consume(n), C) : X(n) ? (l = E, O(n)) : J(n) ? (e.consume(n), E) : I(n)
        }

        function C(n) {
            return 45 === n || 46 === n || 58 === n || 95 === n || V(n) ? (e.consume(n), C) : A(n)
        }

        function A(n) {
            return 61 === n ? (e.consume(n), F) : X(n) ? (l = A, O(n)) : J(n) ? (e.consume(n), A) : E(n)
        }

        function F(n) {
            return null === n || 60 === n || 61 === n || 62 === n || 96 === n ? t(n) : 34 === n || 39 === n ? (e.consume(n), o = n, T) : X(n) ? (l = F, O(n)) : J(n) ? (e.consume(n), F) : (e.consume(n), D)
        }

        function T(n) {
            return n === o ? (e.consume(n), o = void 0, P) : null === n ? t(n) : X(n) ? (l = T, O(n)) : (e.consume(n), T)
        }

        function D(n) {
            return null === n || 34 === n || 39 === n || 60 === n || 61 === n || 96 === n ? t(n) : 47 === n || 62 === n || Z(n) ? E(n) : (e.consume(n), D)
        }
...
const He = {
        ...
        tokenize: function(e, n, t) {
            ...
            function u(n) {
                return 40 === n ? e.attempt(Ue, c, i ? c : s)(n) : 91 === n ? e.attempt(qe, c, i ? a : s)(n) : i ? c(n) : s(n)
            }

            function a(n) {
                return e.attempt(Ve, c, s)(n)
            }
        ...
        resolveTo: function(e, n) {
            ...
            return i = [
                ["enter", a, n],
                ["enter", c, n]
            ], i = j(i, e.slice(r + 1, r + u + 3)), i = j(i, [
                ["enter", s, n]
            ]), i = j(i, ue(n.parser.constructs.insideSpan.null, e.slice(r + u + 4, o - 3), n)), i = j(i, [
                ["exit", s, n], e[o - 2], e[o - 1],
                ["exit", c, n]
            ]), i = j(i, e.slice(o + 1)), i = j(i, [
                ["exit", a, n]
            ]), N(e, r, e.length, i), e
        },
    ...
    Ue = {
        tokenize: function(e, n, t) {
            ...
            function r(n) {
                return Z(n) ? De(e, o)(n) : o(n)
            }

            function o(n) {
                return 41 === n ? c(n) : Ae(e, i, l, "resourceDestination", "resourceDestinationLiteral", "resourceDestinationLiteralMarker", "resourceDestinationRaw", "resourceDestinationString", 32)(n)
            }

            function i(n) {
                return Z(n) ? De(e, u)(n) : c(n)
            }
            ...
            function u(n) {
                return 34 === n || 39 === n || 40 === n ? Te(e, a, t, "resourceTitle", "resourceTitleMarker", "resourceTitleString")(n) : c(n)
            }

            function a(n) {
                return Z(n) ? De(e, c)(n) : c(n)
            }
    ...
    qe = {
        tokenize: function(e, n, t) {
            const r = this;
            return function(n) {
                return Fe.call(r, e, o, i, "reference", "referenceMarker", "referenceString")(n)
            };
...
const Ke = {
        ...
        tokenize: function(e, n, t) {
            ...
            return function(n) {
                ...
                if ("listUnordered" === o ? !r.containerState.marker || n === r.containerState.marker : $(n)) {
                    if (r.containerState.type || (r.containerState.type = o, e.enter(o, {
                            _container: !0
                        })), "listUnordered" === o) return e.enter("listItemPrefix"), 42 === n || 45 === n ? e.check(Ye, t, a)(n) : a(n);
            ...
            function u(n) {
                return $(n) && ++l < 10 ? (e.consume(n), u) : (!r.interrupt || l < 2) && (r.containerState.marker ? n === r.containerState.marker : 41 === n || 46 === n) ? (e.exit("listItemValue"), a(n)) : t(n)
            }

            function a(n) {
                return e.enter("listItemMarker"), e.consume(n), e.exit("listItemMarker"), r.containerState.marker = r.containerState.marker || n, e.check(fe, r.interrupt ? t : c, e.attempt(Xe, f, s))
            }
        ...
        continuation: {
            tokenize: function(e, n, t) {
                const r = this;
                return r.containerState._closeFlow = void 0, e.check(fe, o, i);
                ...
                function i(t) {
                    return r.containerState.furtherBlankLines || !J(t) ? (r.containerState.furtherBlankLines = void 0, r.containerState.initialBlankLine = void 0, l(t)) : (r.containerState.furtherBlankLines = void 0, r.containerState.initialBlankLine = void 0, e.attempt(Ze, n, l)(t))
                }

                function l(o) {
                    return r.containerState._closeFlow = !0, r.interrupt = void 0, te(e, e.attempt(Ke, n, t), "linePrefix", r.parser.constructs.disable.null.includes("codeIndented") ? void 0 : 4)(o)
                }
            }
        },
        exit: function(e) {
...
const Ge = {
    tokenize: function(e) {
        const n = this,
            ...
            }), e.attempt(this.parser.constructs.flowInitial, r, te(e, e.attempt(this.parser.constructs.flow, r, e.attempt(Ee, r)), "linePrefix")));
        return t;
...
function un(e, n, t) {
    ...
    const a = {
            consume: function(e) {
                X(e) ? (r.line++, r.column = 1, r.offset += -3 === e ? 2 : 1, k()) : -1 !== e && (r.column++, r.offset++);
                r._bufferIndex < 0 ? r._index++ : (r._bufferIndex++, r._bufferIndex === l[r._index].length && (r._bufferIndex = -1, r._index++));
                c.previous = e
            },
            enter: function(e, n) {
                const t = n || {};
                return t.type = e, t.start = p(), c.events.push(["enter", t, c]), u.push(t), t
            },
            exit: function(e) {
                const n = u.pop();
        ...
        c = {
            ...
            write: function(e) {
                if (l = j(l, e), d(), null !== l[l.length - 1]) return [];
                return y(n, 0), c.events = ue(i, c.events, c), c.events
            }
        };
    ...
    function g(e, n) {
        return function(t, o, i) {
            ...
            function h(e) {
                return l = e, s = 0, 0 === e.length ? i : m(e[s])
            }
            ...
            function m(e) {
                return function(t) {
                    d = function() {
                        ...
                        function l() {
                            r = e, c.previous = n, c.currentConstruct = t, c.events.length = o, u = i, k()
                        }
                    }(), f = e, e.partial || (c.currentConstruct = e);
                    if (e.name && c.parser.constructs.disable.null.includes(e.name)) return y();
                    return e.tokenize.call(n ? Object.assign(Object.create(c), n) : c, a, g, y)(t)
                }
            }
            ...
            function y(e) {
                return d.restore(), ++s < l.length ? m(l[s]) : i
            }
        }
    }

    function y(e, n) {
        e.resolveAll && !i.includes(e) && i.push(e), e.resolve && N(c.events, n, c.events.length - n, e.resolve(c.events.slice(n), c)), e.resolveTo && (c.events = e.resolveTo(c.events, c))
    }
...
const xn = /\\([!-/:-@[-`{-~])|&(#(?:\d{1,7}|x[\da-f]{1,6})|[\da-z]{1,31});/gi;
...
function vn(e, n, t) {
    ...
    if (35 === t.charCodeAt(0)) {
        const e = t.charCodeAt(1),
            n = 120 === e || 88 === e;
        return kn(t.slice(n ? 2 : 1), n ? 16 : 10)
    }
    return me(t) || e
}
            ...
            function(e) {
                ...
                function r(e) {
                    ...
                    for (; ++a < e.length;)
                        ...
                        const t = n[e[a][0]];
                        bn.call(t, e[a][1].type) && t[e[a][1].type].call(Object.assign({
                            sliceSerialize: e[a][2].sliceSerialize
                        }, r), e[a][1])
                    }
                    if (r.tokenStack.length > 0) {
                        const e = r.tokenStack[r.tokenStack.length - 1];
                        (e[1] || An).call(r, void 0, e[0])
                    }
                    for (t.position = {
                            start: Sn(e.length > 0 ? e[0][1].start : {
                                line: 1,
                                column: 1,
                                offset: 0
                            }),
                            end: Sn(e.length > 0 ? e[e.length - 2][1].end : {
                                line: 1,
                                column: 1,
                                offset: 0
                            })
                ...
                function p(e, n) {
                    ...
                    if (r[0].type !== e.type)
                        if (n) n.call(this, e, r[0]);
                            ...
                            (r[1] || An).call(this, e, r[0])
                        } return t.position.end = Sn(e.end), t
                }
                ...
                function D(e) {
                    ...
                    n.value += this.sliceSerialize(e), n.position.end = Sn(e.end)
                }

                function P(e) {
                    const t = this.stack[this.stack.length - 1];
                    if (l("atHardBreak")) {
                        return t.children[t.children.length - 1].position.end = Sn(e.end), void i("atHardBreak")
                    }!l("setextHeadingSlurpLineEnding") && n.canContainEols.includes(t.type) && (T.call(this, e), D.call(this, e))
                }
                ...
                function $(e) {
                    ...
                    let r;
                    if (t) r = kn(n, "characterReferenceMarkerNumeric" === t ? 10 : 16), i("characterReferenceType");
                    else {
                        r = me(n)
                    }
                    const o = this.stack.pop();
                    o.value += r, o.position.end = Sn(e.end)
                }
                ...
                return function(o, i, l) {
                    ...
                    for (o = t + o.toString(i), s = 0, t = "", r && (65279 === o.charCodeAt(0) && s++, r = void 0); s < o.length;) {
                        if (yn.lastIndex = s, a = yn.exec(o), f = a && void 0 !== a.index ? a.index : o.length, p = o.charCodeAt(f), !a) {
                            t = o.slice(s);
                            break
                        }
...
function An(e, n) {
    ...
    }) + "): a different token (`" + n.type + "`, " + a({
        start: n.start,
        end: n.end
    }) + ") is open") : new Error("Cannot close document, a token (`" + n.type + "`, " + a({
        start: n.start,
        end: n.end
    }) + ") is still open")
}
...
function Tn(e) {
    ...
    for (; ++t < e.length;) {
        ...
        let l = "";
        if (37 === i && V(e.charCodeAt(t + 1)) && V(e.charCodeAt(t + 2))) o = 2;
...
function Mn(e) {
    ...
    let r = t.exec(n),
        o = 0;
    const i = [];
    for (; r;) i.push(Rn(n.slice(o, r.index), o > 0, !0), r[0]), o = r.index + r[0].length, r = t.exec(n);
    return i.push(Rn(n.slice(o), o > 0, !1)), i.join("")
}
    ...
    table: function(e, n) {
        ...
        if (t.length > 0) {
            const r = {
                ...
                i = On(n.children[1]),
                l = Ln(n.children[n.children.length - 1]);
...
const jn = function(e) {
    ...
    if ("function" == typeof e) return _n(e);
...
const qn = function(e, n, t, r) {
    "function" == typeof n && "function" != typeof t && (r = t, t = n, n = null), Un(e, n, (function(e, n) {
...
function $n(e, n) {
    ...
    return l.dangerous = r, l.clobberPrefix = void 0 === t.clobberPrefix || null === t.clobberPrefix ? "user-content-" : t.clobberPrefix, l.footnoteLabel = t.footnoteLabel || "Footnotes", l.footnoteLabelTagName = t.footnoteLabelTagName || "h2", l.footnoteLabelProperties = t.footnoteLabelProperties || {
        ...
        return qn(e, "definition", (e => {
                const t = Wn(e.identifier);
                t && !Vn.call(n, t) && (n[t] = e)
            })),
            function(e) {
                const t = Wn(e);
                return t && Vn.call(n, t) ? n[t] : null
            }
    }(e), l.footnoteById = o, l.footnoteOrder = [], l.footnoteCounts = {}, l.patch = Yn, l.applyData = Kn, l.one = function(e, n) {
        return Xn(l, e, n)
    }, l.all = function(e) {
        return Zn(l, e)
    }, l.wrap = Jn, l.augment = i, qn(e, "footnoteDefinition", (e => {
...
function Xn(e, n, t) {
    ...
    return Qn.call(e.handlers, r) ? e.handlers[r](e, n, t) : e.passThrough && e.passThrough.includes(r) ? "children" in n ? {
        ...n,
        children: Zn(e, n)
    } : n : e.unknownHandler ? e.unknownHandler(e, n, t) : function(e, n) {
        const t = n.data || {},
            r = !("value" in n) || Qn.call(t, "hProperties") || Qn.call(t, "hChildren") ? {
                type: "element",
                tagName: "div",
                properties: {},
                children: Zn(e, n)
...
nt.prototype.property = {}, nt.prototype.normal = {}, nt.prototype.space = null;
class ot {
    constructor(e, n) {
        this.property = e, this.attribute = n
    }
}
ot.prototype.space = null, ot.prototype.boolean = !1, ot.prototype.booleanish = !1, ot.prototype.overloadedBoolean = !1, ot.prototype.number = !1, ot.prototype.commaSeparated = !1, ot.prototype.spaceSeparated = !1, ot.prototype.commaOrSpaceSeparated = !1, ot.prototype.mustUseProperty = !1, ot.prototype.defined = !1;
let it = 0;
const lt = dt(),
    ut = dt(),
    at = dt(),
...
function xt(e) {
    ...
    for (r in e.properties)
        if (kt.call(e.properties, r)) {
            const o = e.properties[r],
                i = new gt(r, e.transform(e.attributes || {}, r), o, e.space);
            e.mustUseProperty && e.mustUseProperty.includes(r) && (i.mustUseProperty = !0), n[r] = i, t[rt(r)] = r, t[rt(i.attribute)] = r
...
const Lt = {
    ...
    zt = tt([bt, vt, Et, Ct, At], "html"),
    Mt = tt([bt, vt, Et, Ct, Ft], "svg"),
    Rt = function(e) {
        if (null == e) return Nt;
        if ("string" == typeof e) return function(e) {
            return Bt(n);
        ...
        if ("function" == typeof e) return Bt(e);
        throw new Error("Expected function, string, or object as test")
    };
...
function _t(e) {
    ...
    if (e.allowedElements || e.disallowedElements || e.allowElement) return n => {
        ! function(e, n, t, r) {
            "function" == typeof n && "function" != typeof t && (r = t, t = n, n = null), jt(e, n, (function(e, n) {
                const r = n[n.length - 1];
                return t(e, r ? r.children.indexOf(e) : null, r)
            }), r)
        }(n, "element", ((n, t, r) => {
...
var Jt = function(e, n) {
    ...
    function p() {
        var e = i(),
            n = a(Qt);
        if (n) {
            if (f(), !a($t)) return u("property missing ':'");
            var t = a(Yt),
                r = e({
                    type: "declaration",
                    property: Zt(n[0].replace(qt, "")),
                    value: t ? Zt(t[0].replace(qt, "")) : ""
                });
            return a(Kt), r
        }
    }
    return l.prototype.content = e, c(),
        function() {
            var e, n = [];
...
function Gt(e, n) {
    ...
    for (var o, i, l = Jt(e), u = "function" == typeof n, a = 0, c = l.length; a < c; a++) o = (t = l[a]).property, i = t.value, u ? n(o, i, t) : i && (r || (r = {}), r[o] = i);
    return r
}
Ut.exports = Gt, Ut.exports.default = Gt;
const er = e(Ut.exports),
    nr = {}.hasOwnProperty,
...
function rr(e, n) {
    const t = [];
    let r, o = -1;
    for (; ++o < n.children.length;) r = n.children[o], "element" === r.type ? t.push(or(e, r, o, n)) : "text" === r.type ? "element" === n.type && tr.has(n.tagName) && Ht(r) || t.push(r.value) : "raw" !== r.type || e.options.skipHtml || t.push(r.value);
    return t
}

function or(e, t, o, i) {
    const l = e.options,
        a = void 0 === l.transformLinkUri ? u : l.transformLinkUri,
        c = e.schema,
        s = t.tagName,
        f = {};
    let p, d = c;
    if ("html" === c.space && "svg" === s && (d = Mt, e.schema = d), t.properties)
        for (p in t.properties) nr.call(t.properties, p) && lr(f, p, t.properties[p], e);
    ...
    const m = t.position || {
        ...
        g = l.components && nr.call(l.components, s) ? l.components[s] : s,
        y = "string" == typeof g || g === n.Fragment;
    if (!r.isValidElementType(g)) throw new TypeError(`Component for name \`${s}\` not defined or is not renderable`);
    if (f.key = o, "a" === s && l.linkTarget && (f.target = "function" == typeof l.linkTarget ? l.linkTarget(String(f.href || ""), t.children, "string" == typeof f.title ? f.title : null) : l.linkTarget), "a" === s && a && (f.href = a(String(f.href || ""), t.children, "string" == typeof f.title ? f.title : null)), y || "code" !== s || "element" !== i.type || "pre" === i.tagName || (f.inline = !0), y || "h1" !== s && "h2" !== s && "h3" !== s && "h4" !== s && "h5" !== s && "h6" !== s || (f.level = Number.parseInt(s.charAt(1), 10)), "img" === s && l.transformImageUri && (f.src = l.transformImageUri(String(f.src || ""), String(f.alt || ""), "string" == typeof f.title ? f.title : null)), !y && "li" === s && "element" === i.type) {
        const e = function(e) {
            let n = -1;
        ...
        f.checked = e && e.properties ? Boolean(e.properties.checked) : null, f.index = ir(i, t), f.ordered = "ol" === i.tagName
    }
    var k;
    return y || "ol" !== s && "ul" !== s || (f.ordered = "ol" === s, f.depth = e.listDepth), "td" !== s && "th" !== s || (f.align && (f.style || (f.style = {}), f.style.textAlign = f.align, delete f.align), y || (f.isHeader = "th" === s)), y || "tr" !== s || "element" !== i.type || (f.isHeader = Boolean("thead" === i.tagName)), l.sourcePos && (f["data-sourcepos"] = [(k = m).start.line, ":", k.start.column, "-", k.end.line, ":", k.end.column].map(String).join("")), !y && l.rawSourcePos && (f.sourcePosition = t.position), !y && l.includeElementIndex && (f.index = ir(i, t), f.siblingCount = ir(i)), y || (f.node = t), h.length > 0 ? n.createElement(g, f, h) : n.createElement(g, f)
}
...
function lr(e, n, t, r) {
    const o = function(e, n) {
        ...
        if (t.length > 4 && "data" === t.slice(0, 4) && Tt.test(n)) {
            if ("-" === n.charAt(4)) {
                const e = n.slice(5).replace(Dt, Ot);
                r = "data" + e.charAt(0).toUpperCase() + e.slice(1)
            } else {
                const e = n.slice(4);
                if (!Dt.test(e)) {
                    let t = e.replace(Pt, It);
    ...
    null != i && i == i && (Array.isArray(i) && (i = o.commaSeparated ? function(e, n) {
        ...
        function t(e, t) {
            ...
            n[r.replace(/-([a-z])/g, ur)] = t
        }
    }(i)), o.space && o.property ? e[nr.call(Lt, o.property) ? Lt[o.property] : o.property] = i : o.attribute && (e[o.attribute] = i))
}
...
function sr(e) {
    for (const n in cr)
        if (ar.call(cr, n) && ar.call(e, n)) {
            const e = cr[n];
            console.warn(`[react-markdown] Warning: please ${e.to?`use \`${e.to}\` instead of`:"remove"} \`${n}\` (see <https://github.com/remarkjs/react-markdown/blob/main/changelog.md#${e.id}> for more info)`), delete cr[n]
        } const t = A().use(Fn).use(e.remarkPlugins || []).use(et, {
            ...e.remarkRehypeOptions,
            allowDangerousHtml: !0
        }).use(e.rehypePlugins || []).use(_t, e),
        r = new x;
    ...
    let i = n.createElement(n.Fragment, {}, rr({
        options: e,
        schema: zt,
        listDepth: 0
    }, o));
