        ...
        76327: function(e, t, n) {
            (function(e, t) {
                ...
                d.exports = (function() {
                    ...
                    function n() {}
                    return n.resetWarningCache = t, p = function() {
                ...
                var m = (s = d.exports) && s.__esModule && Object.prototype.hasOwnProperty.call(s, "default") ? s.default : s,
                    h = function(e, n, r) {
                        var o = !!r,
                            u = t.useRef(r);
                    ...
                    g = function e(t, n) {
                        ...
                        for (var i = {}, s = 0; s < u.length; s += 1) i[u[s]] = !0;
                        for (var a = 0; a < c.length; a += 1) i[c[a]] = !0;
                        var l = Object.keys(i);
                    ...
                    E = function(e, t, n) {
                        return C(e) ? Object.keys(e).reduce(function(o, c) {
                            var i = !C(t) || !g(e[c], t[c]);
                            return n.includes(c) ? (i && console.warn("Unsupported prop change: options.".concat(c, " is not a mutable property.")), o) : i ? r(r({}, o || {}), {}, u({}, c, e[c])) : o
                        }, null) : null
                    },
                    ...
                    b = function(e) {
                        ...
                        if (null === e || C(e) && "function" == typeof e.elements && "function" == typeof e.createToken && "function" == typeof e.createPaymentMethod && "function" == typeof e.confirmCardPayment) return e;
                        throw Error(t)
                    },
                    S = function(e) {
                        var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : k;
                        if (C(e) && "function" == typeof e.then) return {
                            tag: "async",
                ...
                var j = function(e, t) {
                    ...
                    w = function(e) {
                        ...
                        t.useEffect(function() {
                            ...
                            return "async" !== u.tag || s.stripe ? "sync" !== u.tag || s.stripe || t(u.stripe) : u.stripePromise.then(function(n) {
                                    n && e && t(n)
                                }),
                                function() {
                                    e = !1
                        ...
                        }, [r, p, s.elements]), t.useEffect(function() {
                            P(s.stripe)
                        }, [s.stripe]), t.createElement(O.Provider, {
                            value: s
                        }, o)
                    };
                w.propTypes = {
                ...
                T.displayName = "CustomCheckoutContext";
                var I = function(e, t) {
                        if (!e) return null;
                        e.on, e.session;
                        var n = function(e, t) {
                    ...
                    B = function(e) {
                        ...
                        t.useEffect(function() {
                            var e = !0;
                            return "async" !== u.tag || p.stripe ? "sync" === u.tag && u.stripe && !m.current && (m.current = !0, u.stripe.initCustomCheckout(r).then(function(e) {
                                    e && (d(u.stripe, e), e.on("change", a))
                                })) : u.stripePromise.then(function(t) {
                                    t && e && !m.current && (m.current = !0, t.initCustomCheckout(r).then(function(e) {
                                        e && (d(t, e), e.on("change", a))
                                    }))
                                }),
                                function() {
                                    e = !1
                        ...
                        t.useEffect(function() {
                            if (p.customCheckoutSdk) {
                                !r.clientSecret || C(v) || g(r.clientSecret, v.clientSecret) || console.warn("Unsupported prop change: options.client_secret is not a mutable property.");
                                var e, t, n = null == v || null == (e = v.elementsOptions) ? void 0 : e.appearance,
                                    o = null == r || null == (t = r.elementsOptions) ? void 0 : t.appearance;
                                o && !g(o, n) && p.customCheckoutSdk.changeAppearance(o)
                            }
                        }, [r, v, p.customCheckoutSdk]), t.useEffect(function() {
                            P(p.stripe)
                        }, [p.stripe]);
                        var E = t.useMemo(function() {
                            return I(p.customCheckoutSdk, s)
                        }, [p.customCheckoutSdk, s]);
                        return p.customCheckoutSdk ? t.createElement(N.Provider, {
                            value: p
                        }, t.createElement(T.Provider, {
                            value: E
                        }, o)) : null
                    };
                B.propTypes = {
                        ...
                        var r = "".concat(e.charAt(0).toUpperCase() + e.slice(1), "Element"),
                            o = n ? function(e) {
                                ...
                                var o, u = n.id,
                                    ...
                                    j = M("mounts <".concat(r, ">")),
                                    w = "elements" in j ? j.elements : null,
                                    x = "customCheckoutSdk" in j ? j.customCheckoutSdk : null,
                                    A = c(t.useState(null), 2),
                                    R = A[0],
                                    N = A[1],
                                    _ = t.useRef(null),
                                    T = t.useRef(null);
                                h(R, "blur", l), h(R, "focus", p), h(R, "escape", m), h(R, "click", C), h(R, "loaderror", v), h(R, "loaderstart", g), h(R, "networkschange", k), h(R, "confirm", b), h(R, "cancel", S), h(R, "shippingaddresschange", P), h(R, "shippingratechange", O), h(R, "change", d), f && (o = "expressCheckout" === e ? f : function() {
                                    f(R)
                                }), h(R, "ready", o), t.useLayoutEffect(function() {
                                    if (null === _.current && null !== T.current && (w || x)) {
                                        var t = null;
                                        x ? t = x.createElement(e, a) : w && (t = w.create(e, a)), _.current = t, N(t), t && t.mount(T.current)
                                    }
                                }, [w, x, a]);
                                var I = y(a);
                                return t.useEffect(function() {
                                    if (_.current) {
                                        var e = E(a, I, ["paymentRequest"]);
                                        e && _.current.update(e)
                                    }
                                }, [a, I]), t.useLayoutEffect(function() {
                                    return function() {
                                        if (_.current && "function" == typeof _.current.destroy) try {
                ...
                var W = function() {
                    ...
                    q = Y ? function(e) {
                        ...
                        return t.useLayoutEffect(function() {
                            return !u.current && o && null !== c.current && (o.mount(c.current), u.current = !0),
                                function() {
                                    if (u.current && o) try {
                    ...
                    Q = U("epsBank", Y),
                    X = U("payment", Y),
                    Z = U("expressCheckout", Y),
                    ee = U("paymentRequestButton", Y),
                    et = U("linkAuthentication", Y),
                    en = U("address", Y),
                    er = U("shippingAddress", Y),
                    eo = U("paymentMethodMessaging", Y),
                    eu = U("affirmMessage", Y),
                    ec = U("afterpayClearpayMessage", Y);
                e.AddressElement = en, e.AffirmMessageElement = eu, e.AfterpayClearpayMessageElement = ec, e.AuBankAccountElement = D, e.CardCvcElement = $, e.CardElement = F, e.CardExpiryElement = V, e.CardNumberElement = H, e.CustomCheckoutProvider = B, e.Elements = w, e.ElementsConsumer = A, e.EmbeddedCheckout = q, e.EmbeddedCheckoutProvider = function(e) {
                    var n = e.stripe,
                        r = e.options,
                        o = e.children,
                        u = t.useMemo(function() {
                    ...
                    t.useEffect(function() {
                        if (!s.current && !i.current) {
                            var e = function(e) {
                                s.current || i.current || (s.current = e, i.current = s.current.initEmbeddedCheckout(r).then(function(e) {
                                    p({
                                        embeddedCheckout: e
                                    })
                                }))
                            };
                            "async" === u.tag && !s.current && (r.clientSecret || r.fetchClientSecret) ? u.stripePromise.then(function(t) {
                                t && e(t)
                            }) : "sync" === u.tag && !s.current && (r.clientSecret || r.fetchClientSecret) && e(u.stripe)
                        }
                    }, [u, r, l, s]), t.useEffect(function() {
                        return function() {
                            l.embeddedCheckout ? (i.current = null, l.embeddedCheckout.destroy()) : i.current && i.current.then(function() {
                ...
                }, e.EpsBankElement = Q, e.ExpressCheckoutElement = Z, e.FpxBankElement = z, e.IbanElement = G, e.IdealBankElement = J, e.LinkAuthenticationElement = et, e.P24BankElement = K, e.PaymentElement = X, e.PaymentMethodMessagingElement = eo, e.PaymentRequestButtonElement = ee, e.ShippingAddressElement = er, e.useCustomCheckout = function() {
                    _(t.useContext(N), "calls useCustomCheckout()");
...
//# sourceMappingURL=6327.98110c46ac95abea.js.map
